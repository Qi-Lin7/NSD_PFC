...
unique_imgs_list = np.load(os.path.join(intermediate_dir, 'features', 'sub0{}_share_img_order.npy'.format(curr_sub)))

# Load the betas
if end_ind < len(unique_imgs_list):
    betas_array = Parallel(n_jobs=16)(
...
reordered_betas_dir = os.path.join(intermediate_dir, 'betas_native', 'sub0{}_betas_{}to{}_{}_share_norm'.format(curr_sub,
                                                                        start_ind,
                                                                        end_ind,
                                                                        curr_roi))
